...
// la línea de abajo, antes estaba así =>  const handlePlanSelection = async (planType: string) => {

  const handlePlanSelection = async (planType: 'free' | 'premium' | 'pro' | 'weekly') => {
    if (!user) {
    ...
    // Obtener el precio correspondiente según el tipo de plan y el estado anual
    let planPrice = isAnnual
      ? pricing[planType].annual
      : pricing[planType].monthly;
      ...
      <div className="text-center">
        ...
        <div className="flex justify-start items-start flex-wrap -mx-2 mb-8">
            ...
            <div className="text-left flex-grow-0 mt-2 pt-0">
              <ul className="list-none pl-0 mt-0 mb-0">
                ...
                <li className="flex items-center">
                  ...
                  Sin capacidad de guardar tus outfits.
                </li>
                <li className="flex items-center">
                  <svg
                    className={`w-4 h-4 ${hovered[0] ? 'text-blue-500' : 'text-gray-500'} mr-2`}
          ...
          >
            ...
            <p className="text-2xl font-bold mt-0 mb-0">
              {pricing.premium[isAnnual ? 'annual' : 'monthly']} <span className="text-base font-bold">$</span>
              <span className="text-base font-bold">{isAnnual ? '/ año' : '/ mes'}</span>
            </p>
            <button 
            ...
            <div className="text-left flex-grow-0 mt-2 pt-0">
              <ul className="list-none pl-0 mt-0 mb-0">
                ...
                <li className="flex items-center">
                  ...
                  Capacidad de guardar 10 outfits. 
                </li>
                <li className="flex items-center">
                  <svg
                    className={`w-4 h-4 ${hovered[1] ? 'text-blue-500' : 'text-gray-500'} mr-2`}
